...
- **AI Co-authorship:** All commits made by an AI agent MUST include a `Co-authored-by` trailer for that AI (e.g., `Co-authored-by: Claude Sonnet 4.6 <noreply@anthropic.com>` or `Co-authored-by: Gemini CLI <gemini-cli@google.com>`).
